...
/*автослайдер отключен */
  ...
  dispose() {
    ...
    /*this.#autoplay('stop');*/ /*автослайдер отключен */
  ...
  #onClick(e) {
    ...
    /*this.#autoplay('stop');*//* автослайдер*/
   ...
   /* this.#config.loop ? this.#autoplay() : null;*/ /* автослайдер*/
  }
/* автослайдер*/
/*  #onMouseEnter() {
    this.#autoplay('stop');
  ...
  */
  ...
  #attachEvents() {
    this.#state.events = {
     ...
     /* mouseenter: [this.#state.el, this.#onMouseEnter.bind(this), true],*//* автослайдер*/
     /* mouseleave: [this.#state.el, this.#onMouseLeave.bind(this), true],*//* автослайдер*/
      ...
      /*touchstart: [this.#state.el, this.#onSwipeStart.bind(this), this.#config.swipe],*//* автослайдер */
     /* mousedown: [this.#state.el, this.#onSwipeStart.bind(this), this.#config.swipe],*/ /*автослайдер */
     ...
     /* visibilitychange: [document, this.#onVisibilityChange.bind(this), true]*//* автослайдер*/
    };
